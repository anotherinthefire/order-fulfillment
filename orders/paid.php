...
<body>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text">Paid Orders</span>
    </div>
    ...
    if (isset($_GET['search']) && !empty($_GET['search'])) {
      $search = $_GET['search'];
      $sql = "SELECT * FROM orders WHERE status = 3 AND (full_name LIKE '%$search%' OR contact LIKE '%$search%') ORDER BY ord_date DESC LIMIT $offset, $perPage";
    } else {
      $sql = "SELECT * FROM orders WHERE status = 3 ORDER BY ord_date DESC LIMIT $offset, $perPage";
    }
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<tr>
                ...
                <td>
                  ...
                  <div class="more-options">
                    ...
                    <form action="./actions/to-pickup.php" method="post">
                      <input type="hidden" name="orderId" value="' . $orderId . '">
                      <button type="submit" name="pickup" class="status">Pickup</button>
                    </form>
                    <a href="paid-view.php?id=' . $orderId . '"><button class="view">View</button></a>
                  </div>
                </td>
              </tr>';
      }
      ...
      $totalOrders = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM orders WHERE status = 3"));
