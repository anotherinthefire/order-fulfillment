    ...
    <section class="home-section">
        ...
        ?>
                ...
                <form action="actions/to-followup.php" method="POST" style="display: inline;">
                    ...
                    <button style="margin-left: 60%; margin-bottom: 50px;" type="submit" name="followUp" class="status">Follow Up</button>
                </form>

                <button onclick="openModal()">Proof</button>
                <button onclick="showRemarksForm()">Remarks</button>
                <a href="refund.php" style="color:black;">
                    <button>Back</button>
                </a>
